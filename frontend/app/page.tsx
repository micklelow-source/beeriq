  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      <header className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight">New Hampshire breweries</h1>
        <p className="mt-1 text-neutral-500">Live tap lists, change history, and BrewIQ scores.</p>
      </header>
